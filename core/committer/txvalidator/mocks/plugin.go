...
func (_m *Plugin) Validate(block *cached.Block, namespace string, txPosition int, actionPosition int, contextData ...validation.ContextDatum) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*cached.Block, string, int, int, ...validation.ContextDatum) error); ok {
